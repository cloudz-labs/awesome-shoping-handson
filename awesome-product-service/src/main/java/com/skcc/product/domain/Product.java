...
public class Product {
	...
	public Product(long id, String name, long categoryId, String active, long originalPrice, long salePercentage,
	...
	public String toString() {
		return "Product [id=" + id + ", name=" + name + ", categoryId=" + categoryId + ", active=" + active
